      ...
      for (const week of plan.weeks) {
        for (const day of week.days) {
          ...
          for (const meal of day.meals) {
            ...
            const savedMeal = await db.createMeal({ plan_day_id: savedDay.id, meal_order: Array.from(day.meals).indexOf(meal) + 1, name: meal.name, time_of_day: meal.time_of_day, description: meal.description, image_url: imgUrl, calories: meal.calories, protein_g: meal.protein_g, carbs_g: meal.carbs_g, fat_g: meal.fat_g, recipe: meal.recipe });
