...
Responde SOLO con JSON válido, sin texto adicional, con esta estructura exacta:
{
  ...
  for (let i = 0; i < totalDays; i++) {
    ...
    const dayName = dayNames[i % 7];
      const dayPrompt = `${fullPrompt}\n\nGenera SOLO el dia ${d} (${dayName}) con 5 comidas. Responde UNICAMENTE con este JSON sin texto extra: {"day":${d},"day_name":"${dayName}","meals":[{"meal_type":"Desayuno","name":"...","calories":0,"protein":0,"carbs":0,"fat":0,"recipe":"...","ingredients":[{"name":"...","quantity":100,"unit":"g"}]},{"meal_type":"Media manana","name":"...","calories":0,"protein":0,"carbs":0,"fat":0,"recipe":"...","ingredients":[{"name":"...","quantity":100,"unit":"g"}]},{"meal_type":"Comida","name":"...","calories":0,"protein":0,"carbs":0,"fat":0,"recipe":"...","ingredients":[{"name":"...","quantity":100,"unit":"g"}]},{"meal_type":"Merienda","name":"...","calories":0,"protein":0,"carbs":0,"fat":0,"recipe":"...","ingredients":[{"name":"...","quantity":100,"unit":"g"}]},{"meal_type":"Cena","name":"...","calories":0,"protein":0,"carbs":0,"fat":0,"recipe":"...","ingredients":[{"name":"...","quantity":100,"unit":"g"}]}]}`;
